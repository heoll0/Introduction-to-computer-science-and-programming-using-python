...
class Message(object):
    ...
    def get_valid_words(self):
        ...
        '''
        copy_wordlist = self.valid_words
        return copy_wordlist
    ...
    def build_shift_dict(self, shift):
        ...
        dic={}
        for i in range(26):
            dic[lower[i]] = lower[i+shift]
            dic[upper[i]] = upper[i+shift]
        return dic
    ...
    def apply_shift(self, shift):
        ...
        for i in text:
            if i in string.ascii_lowercase or i in string.ascii_uppercase:
                message_test=message_test + dic[i]
            else:
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.message_text_encryted=Message.apply_shift(self,shift)
    ...
    def get_message_text_encrypted(self):
        ...
        '''
        return self.message_text_encryted
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        message=Message.get_message_text(self)
        split_message=message.split()
        list_num_validword=[]
        for i in range(26):
            num_validword=0
            for j in split_message:
                shift_message=shift(j,i)
                if is_word(word_list, shift_message):
                    num_validword += 1
            list_num_validword.append(num_validword)
        largest_num_validword = max(list_num_validword)
        shiftnum = 26 - list_num_validword.index(largest_num_validword)
        decrypt_message=shift(message,26-shiftnum)
        return shiftnum, decrypt_message
